...
1. Compile the workspace by navigating to the workspace and entering in terminal:
```
catkin_make
```
2. Source the workspace by entering:
```
source devel/setup.bash
```
3. Launch the Gazebo simulator with the Turtlebot robot and simulation environment by entering:
```
roslaunch turtlebot3_neural_network turtlebot3_square.launch
```
4. To test the trained model in the Gazebo environment, enter:
```
